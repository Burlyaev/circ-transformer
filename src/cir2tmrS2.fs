...
let cir2tmrS2F (cirD: cirDicT) voterL =    
   ...
   //process Definition
    ...
    let votStrL_1=List.map2 (fun inp detec -> "\t voterS2D "+"vot_"+inp+"("+ detec) voterL detectStrL
    let votStrL_2=List.map2 (fun inp out -> ", failWire,"+out+","+inp+");") voterL votOutNameL
